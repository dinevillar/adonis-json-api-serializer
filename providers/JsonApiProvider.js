...
class JsonApiProvider extends ServiceProvider {
  ...
  _registerController() {
    this.app.bind('JsonApi/Src/Controller/ResourceController', () => require('../src/Controllers/JsonApiResourceController'));
    this.app.alias('JsonApi/Src/Controller/ResourceController', 'JsonApiResourceController');
  }
